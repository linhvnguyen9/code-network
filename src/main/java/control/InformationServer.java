...
public class InformationServer extends Thread {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(InformationServer.class.getName()).log(Level.SEVERE, (String)null, var2);
        }

    }

    public InformationServer(ServerSocket ss) {
        this.myServer = ss;
    }

    public InformationServer(Server main) {
    ...
    public void listening() throws IOException {
        while(true) {
            try {
                ...
                InformationServerThread clientThread = new InformationServerThread(clientSocket, this);
                clientThread.start();
