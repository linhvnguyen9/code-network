        ...
        try {
            ...
            if (this.clientSocket != null) {
                try {
                    ...
                    Logger.getLogger(StringClientThread_06112018_1.class.getName()).log(Level.SEVERE, (String)null, var33);
                }
            }
            ...
            if (this.is != null && this.os != null) {
                try {
                    ...
                    Logger.getLogger(StringClientThread_06112018_1.class.getName()).log(Level.SEVERE, (String)null, var32);
                }
            }
            ...
            if (this.clientSocket != null) {
                try {
                    ...
                    Logger.getLogger(StringClientThread_06112018_1.class.getName()).log(Level.SEVERE, (String)null, var31);
                }
            }
            ...
            if (this.is != null && this.os != null) {
                try {
                    ...
                    Logger.getLogger(StringClientThread_06112018_1.class.getName()).log(Level.SEVERE, (String)null, var30);
                }
            }
            ...
            if (this.clientSocket != null) {
                try {
                    ...
                    Logger.getLogger(StringClientThread_06112018_1.class.getName()).log(Level.SEVERE, (String)null, var29);
                }
            }
        } finally {
            System.out.println("Client IP : " + this.clientSocket.getInetAddress().getHostAddress());
            if (this.is != null && this.os != null) {
                try {
                    ...
                    Logger.getLogger(StringClientThread_06112018_1.class.getName()).log(Level.SEVERE, (String)null, var28);
                }
            }
            ...
            if (this.clientSocket != null) {
                try {
                    ...
                    Logger.getLogger(StringClientThread_06112018_1.class.getName()).log(Level.SEVERE, (String)null, var27);
                }
            }
